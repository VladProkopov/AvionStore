...
function AllProducts() {
	...
	function filterFurnit() {
		let productTmp = product.filter((item) => {
	...
	return (
	  <div className="all__products__pages">
		...
		<div className="all__products">
			...
			<div className="filter__dropmob">
				<button onClick={dropFilter} className="dropbtn__filter__product">Filters &dArr;</button>
				<button className="dropbtn__filter__price">Sorting &dArr;</button>
			</div>
